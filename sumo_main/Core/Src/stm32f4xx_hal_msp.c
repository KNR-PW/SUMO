...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = ADC_Lin4_Pin|ADC_Lin2_Pin|ADC_Lin3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_Lin1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_Lin1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, ADC_Lin4_Pin|ADC_Lin2_Pin|ADC_Lin3_Pin);

    HAL_GPIO_DeInit(ADC_Lin1_GPIO_Port, ADC_Lin1_Pin);
