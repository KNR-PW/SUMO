...
#define ADC_Lin4_Pin GPIO_PIN_0
#define ADC_Lin4_GPIO_Port GPIOC
#define ADC_Lin2_Pin GPIO_PIN_1
#define ADC_Lin2_GPIO_Port GPIOC
...
#define WRONG_PIN_Pin GPIO_PIN_6
#define WRONG_PIN_GPIO_Port GPIOA
...
#define PILOCIK_GPIO_Port GPIOB
#define PILOCIK_EXTI_IRQn EXTI0_IRQn
#define DIR_MOT_1_R_Pin GPIO_PIN_1
#define DIR_MOT_1_R_GPIO_Port GPIOB
#define DIR_MOT_1_L_Pin GPIO_PIN_2
#define DIR_MOT_1_L_GPIO_Port GPIOB
#define DIR_MOT_2_L_Pin GPIO_PIN_13
